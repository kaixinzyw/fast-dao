...
public class FileCreateConfig {
     ...
     * Pojo文件路径
     */
    private final String beanPackage = CodeCreateModule.POJO.codeModule;
...
//    private String beanFieldsPackage = CodeCreateModule.PojoFields.codeModule;
     ...
     * DB模板文件路径
     */
    private final String beanFastDao = CodeCreateModule.FastDAO.codeModule;
    /**
     * service文件路径
     */
    private final String servicePackage = CodeCreateModule.Service.codeModule;
    //    /**
//     * DAO文件路径
//     */
    private final String daoPackage = CodeCreateModule.DAO.codeModule;
    /**
     * DTO文件路径
     */
    private final String dtoPackage = CodeCreateModule.DTO.codeModule;
     ...
     * </dependency>
     */
    private Boolean usePOJOSwagger2 = Boolean.FALSE;
     ...
     * DOT继承POJO
     */
    private Boolean dtoExtendsPOJO = Boolean.FALSE;
    ...
    public void setCreateTables(String... tables) {
        ...
        createTables.addAll(Arrays.asList(tables));
    }
    ...
    public void setUsePOJOSwagger2(Boolean usePOJOSwagger2) {
        this.usePOJOSwagger2 = usePOJOSwagger2;
    }
    ...
    public void setDtoExtendsPOJO(Boolean dtoExtendsPOJO) {
        this.dtoExtendsPOJO = dtoExtendsPOJO;
    }
...
//    }
    ...
    public Boolean getDtoExtendsPOJO() {
        return dtoExtendsPOJO;
    }

    public Boolean getUsePOJOSwagger2() {
        return usePOJOSwagger2;
    }
}
