    ...
    private static void createFile(FileCreateConfig conf, List<TableInfo> tableInfos) throws IOException, TemplateException {
        ...
        for (TableInfo tableInfo : tableInfos) {
            ...
            for (String module : modules) {
                ...
                } else if (FileCreateConfig.CodeCreateModule.PojoTemplate.codeModule.equals(module)) {
                    Template temp = cfg.getTemplate("PojoTemplate.ftl");
                    createFile(conf, tableInfo.getPojoTemplateFilePath(), root, temp);
