...
public class DbUtils {
    ...
    public void setPackPath(FileCreateConfig conf, TableInfo tableInfo) {
        ...
        String pojoFieldsPackPath = conf.getBasePackage() + "." + conf.getBeanPackage() + "." + conf.getBeanTemplate() + "." + conf.getBeanFieldsPackage() + prefixPath;
        String pojoTemplatePackPath = conf.getBasePackage() + "." + conf.getBeanPackage() + "." + conf.getBeanTemplate() + prefixPath;
        ...
        tableInfo.setPojoTemplatePackPath(pojoTemplatePackPath);
        tableInfo.setPojoTemplateName(tableInfo.getPojoName() + "Template");
        tableInfo.setPojoTemplateClassPackPath(tableInfo.getPojoTemplatePackPath() + "." + tableInfo.getPojoTemplateName());
        tableInfo.setPojoTemplateFilePath(javabasePath + tableInfo.getPojoTemplatePackPath().replace(".", separator) + separator + tableInfo.getPojoTemplateName() + ".java");
        ...
        tableInfo.setServiceName(tableInfo.getPojoName() + "Service");
