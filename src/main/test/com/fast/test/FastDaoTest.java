...
import com.fast.generator.util.GenTable;
import com.fast.generator.util.GenUtils;
...
//        getTableInfo();
    ...
    public static void selectObject() {
        ...
        userFastDAO.andLeftBracket().leftBracket().userName("test1").rightBracket().orLeftBracket().age().less(10).rightBracket().rightBracket();
