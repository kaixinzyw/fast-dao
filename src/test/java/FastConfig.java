...
//        AutomaticParameterSetting setting = new AutomaticParameterSetting(FastMyBatisImpl.class, "id", PrimaryKeyType.AUTO);
//
//        /**
//         * 配置创建
...
//         * 参数2:  逻辑删除标记默认值
//         */
//        setting.openLogicDelete("deleted", Boolean.TRUE);
//
//        /**
